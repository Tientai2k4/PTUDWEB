...
namespace ShopManager.Helper
{
	public static class PasswordHelper
	{
		...
		public static string ToSHA256Hash(this string password, string? saltKey)
		{
			...
			sha256.ComputeHash(Encoding.UTF8.GetBytes(string.Concat(password, saltKey)));
			sha256.Clear();
		...
		public static string ToSHA512Hash(this string password, string? saltKey)
		{
			...
			byte[] encryptedSHA512 =
		   sha512.ComputeHash(Encoding.UTF8.GetBytes(string.Concat(password, saltKey)));
			sha512.Clear();
