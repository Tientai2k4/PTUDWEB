...
namespace ShopManager.DAL 
{
    public class ProductDAL
    {
        ...
        public List<Product> GetListProduct(int? idCategory)
        {
            ...
            using (SqlCommand command = new SqlCommand())
            {
                ...
                string query = @"select a.id as ProductId, a.title as ProductTitle, a.content as ProductContent, a.img as ProductImg, a.price as ProductPrice, 
        ...
        public List<Product> GetProducts_Pagination(int? idCategory, int pageIndex,
 ...
 SELECT ROW_NUMBER() OVER ( " + sortQuery + @" ) AS
RowNumber,
 a.id as ProductId, a.title as ProductTitle,
a.content as ProductContent, a.img as ProductImg,
a.price as ProductPrice,
 a.rate as ProductRate, a.createAt as ProductCreateAt,
a.updateAt as ProductUpdateAt,
 b.id as CategoryId, b.title as CategoryTitle
FROM product a join category b on a.categoryId = b.Id "
               + categoryCondition + @"
 ) TableResult
 WHERE TableResult.RowNumber BETWEEN( @PageIndex -1) *
@PageSize + 1
 ...
 ";
        ...
        public Product GetProductById(int Id)
        {
            ...
            using (SqlCommand command = new SqlCommand())
            {
                command.Connection = connect.getConnecttion();
                command.CommandType = System.Data.CommandType.Text;
                string query = @"select a.id as ProductId, a.title as ProductTitle, a.content as ProductContent, a.img as ProductImg, a.price as ProductPrice, a.rate as ProductRate, a.createAt as ProductCreateAt, a.updateAt as ProductUpdateAt, b.id as CategoryId, b.title as CategoryTitle from product a join category b on a.categoryId = b.Id where a.Id = @Id ";
                command.CommandText = query;
