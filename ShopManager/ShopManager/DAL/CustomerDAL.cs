    ...
    public class CustomerDAL
    {
            ...
            using (SqlCommand command = new SqlCommand())
            {
                ...
                while (reader.Read())
                {
                    ...
                    customer = new Customer()
                    {
                        ...
                        DateOfBirth = reader["dateOfBirth"] == DBNull.Value ? DateOnly.Parse(null) : DateOnly.FromDateTime(DateTime.Parse(reader["dateOfBirth"]?.ToString())),
        ...
        public bool SignUp(Customer customer)
        {
            ...
            using (SqlCommand command = new SqlCommand())
            {
                ...
                img, address, registeredAt, updateAt, password, randomKey,
                isActive, role)
                 values
                 (@lastName, @firstName, @phone, @email, @dateOfBirth,
                @img, @address, @registeredAt, @updateAt, @password,
                @randomKey, 1 , 0); ";
                command.CommandText = query;
                ...
                customer.DateOfBirth == null ? DBNull.Value : customer.DateOfBirth);
